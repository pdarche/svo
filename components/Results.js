...
import { styles } from "../styles/resultsChart";
...
export default class Results extends React.Component {
  ...
  _create(props) {
    ...
    let container = svg
      ...
      .attr(
        "transform",
        "translate(" + dims.margin.left + "," + dims.margin.left + ")"
      );

    let chart = container.append("g").attr("class", "results");
    ...
    chart
      ...
      .attr(
        "transform",
        "translate(" + -30 + "," + dims.height / 2 + ") rotate(-90)"
      )
      .style("font-size", 12)
    ...
    chart
      ...
      .attr(
        "transform",
        "translate(" + dims.width / 2 + "," + (dims.height + 30) + ")"
      )
      .style("font-size", 12)
      .text("Payoff to Self");

    chart.append("g").attr("class", "ring");
    ...
    chart
      ...
      .attr(
        "transform",
        "translate(" + scales.x(50) + ", " + -scales.y(50) + ")"
      )
      .text("Altruist")
      .style("font-size", 12);
