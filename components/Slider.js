...
export default class Slider extends React.Component {
  ...
  _create(props) {
    ...
    let sliderContainer = svg
      .append("g")
      .attr("class", "slider-container")
      .attr(
        "transform",
        "translate(" + dims.margin.left + "," + dims.height / 2 + ")"
      );
  ...
  _update(slider, scales, dims, props) {
    ...
    let text1 = handleGroup
      .append("text")
      .attr("class", "label")
      .attr("y", -13)
      .text(Math.round(props.data[0]));

    let text2 = handleGroup
      .append("text")
      .attr("class", "label")
      .attr("y", 25)
